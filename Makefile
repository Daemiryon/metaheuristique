...
# MAIN
main: build/main.o build/io.o build/io.o build/list.o build/hashmap.o build/hash.o build/clients.o
	gcc build/main.o build/io.o build/io.o build/list.o build/hashmap.o build/hash.o build/clients.o -o main -std=c99 -Wall -Wextra -pedantic -O0 -g3 -fsanitize=address -fno-omit-frame-pointer -fno-optimize-sibling-calls
